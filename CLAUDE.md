...
- **Prompt Templates**: Located in `prompts/` directory:
  - `analyze_module_forward.txt`: Instructs agent how to analyze module forward methods
  - `expand_module_references.txt`: Instructs agent how to expand module references recursively
